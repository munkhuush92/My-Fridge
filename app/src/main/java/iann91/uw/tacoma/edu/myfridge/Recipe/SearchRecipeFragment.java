 ...
 * {@link SearchRecipeFragment.OnSearchFragmentInteractionListener} interface
...
public class SearchRecipeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_search_recipe, container,
                false);

        final Button searchButton = (Button)view.findViewById(R.id.searchRecipeButton);
        final EditText searchEditText = (EditText) view.findViewById(R.id.recipeNameEditText);
        searchButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                RecipeFragment recipeFragment = RecipeFragment.newInstance(searchEditText.getText().toString());
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onSearchRecipeFragmentInteraction(uri);
        }
    }
    ...
    public interface OnSearchFragmentInteractionListener {
        ...
        void onSearchRecipeFragmentInteraction(Uri uri);
    }
}
